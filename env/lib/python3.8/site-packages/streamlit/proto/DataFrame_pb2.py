...
_DATETIMEINDEX.fields_by_name['data'].message_type = streamlit_dot_proto_dot_Common__pb2._INT64ARRAY
...
_ANYARRAY.fields_by_name['datetimes'].message_type = streamlit_dot_proto_dot_Common__pb2._INT64ARRAY
